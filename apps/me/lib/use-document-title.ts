...
/**
 * Sets `document.title` for the current client page.
 *
 * Renders as ``"<title> · BearHacks 2026"`` because the root layout's
 * metadata title template (`%s · BearHacks 2026`) is applied client-side
