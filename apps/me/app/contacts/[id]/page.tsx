              ...
              {profile.linkedin_url ? (
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex min-h-(--bearhacks-touch-min) items-center gap-3 rounded-(--bearhacks-radius-md) border border-(--bearhacks-border) bg-(--bearhacks-surface-alt) px-4 py-3 no-underline hover:bg-(--bearhacks-surface-raised)"
                  >
                    <svg
                      aria-hidden="true"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="h-5 w-5 shrink-0 text-(--bearhacks-link)"
                    >
                    ...
                    <div className="flex min-w-0 flex-1 flex-col">
                      <span className="text-xs font-semibold uppercase tracking-[0.1rem] text-(--bearhacks-on-surface-muted)">
                        LinkedIn
                      </span>
                      <span className="truncate text-sm font-medium text-(--bearhacks-link) underline underline-offset-2">
