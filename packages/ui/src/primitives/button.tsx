...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  pill:
    "rounded-[var(--bearhacks-radius-pill)] px-6 py-3 bg-(--bearhacks-surface) text-(--bearhacks-fg) border border-(--bearhacks-border) shadow-(--bearhacks-shadow-card) hover:bg-(--bearhacks-cream) disabled:hover:bg-(--bearhacks-surface)",
};
